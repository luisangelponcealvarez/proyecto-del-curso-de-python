#Es un espacion en memoria donde se guardan y recuperan los datos que utiliza un programa
 
#Cada variable debe de tener un nombre, con el cual se podrá identificar y referirse a ella, durante el desarrollo de un programa
...
#Es decir, una variable no podría llamarse: "print, nom bre"
